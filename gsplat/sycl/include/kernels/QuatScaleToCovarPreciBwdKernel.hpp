...
template <typename T> struct QuatScaleToCovarPreciBwdKernel {
    ...
    QuatScaleToCovarPreciBwdKernel(
        ...
        : m_N(N), m_quats(quats), m_scales(scales), m_v_covars(v_covars),
          m_v_precis(v_precis), m_triu(triu), m_v_scales(v_scales),
          m_v_quats(v_quats) {}
