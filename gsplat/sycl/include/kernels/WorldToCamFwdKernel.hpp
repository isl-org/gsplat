 ...
 * From: https://github.com/nerfstudio-project/gsplat/blob/main/gsplat/cuda/csrc/world_to_cam_fwd.cu
 ****************************************************************************/
...
struct WorldToCamFwdKernel{
    ...
    : m_C(C), m_N(N), 
      ...
      m_means_c(means_c), m_covars_c(covars_c)  
    {}
