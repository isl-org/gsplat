...
inline void persp_proj(
    ...
    T rz = 1.f / z;
    T rz2 = rz * rz;
    T tx = z * sycl::min(lim_x_pos, sycl::max(-lim_x_neg, x * rz));
    T ty = z * sycl::min(lim_y_pos, sycl::max(-lim_y_neg, y * rz));
